...
public class LeilaoTestAssertThat {
...
//        assertEquals(200.0, maiorLance, DELTA);
        assertThat(maiorLance, equalTo(200.0));
        assertThat(maiorLance, closeTo(200.0,DELTA));
        //a biblioteca closeTo foi importada do hamcrest, inseridon o graddle
...
//        assertThat(tresMaioresLancesDevolvidos, hasItem(new Lance(new Usuario("Joao"), 400.0)));
//
//        assertEquals(300.0, tresMaioresLancesDevolvidos.get(1).getValor(), DELTA);
//        assertEquals(200.0, tresMaioresLancesDevolvidos.get(2).getValor(), DELTA);

        //unico assert para todos os asserts feitos aciam
        //os lances foram inseridos na ordem que são esperado
